...
describe('multiple stores:', () => {
  ...
  test('dispatch should not contain another stores reducers', () => {
    ...
    expect((store2.dispatch.count as any).increment).not.toBeDefined()
    expect((store1.dispatch as any).count.add).not.toBeDefined()
  ...
  test('dispatch should not contain another stores effects', () => {
    ...
    expect((store2.dispatch as any).say).not.toBeDefined()
    expect((store1.dispatch as any).speak).not.toBeDefined()
